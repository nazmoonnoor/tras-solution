...
{
    public class BattalionProfileViewModel : IMapFrom<Person>, IHaveCustomMappings
    {
        ...
        [DataType(DataType.Text)]
        [DisplayName("STA/Pt-1 Order No")]
        [Display(Prompt = "STA/Pt-1 Order No")]
        public string Stdp1No { get; set; }

        [Required(ErrorMessage = "Required")]
        [DataType(DataType.Date)]
        [DisplayName("STA/Pt-1 Date")]
        ...
        [DisplayName("Distination Unit")]
        [UIHint("DropDownList")]
        public int? UnitId { get; set; }
        public string UnitName { get; set; }

        [Required(ErrorMessage = "Required")]
        [DisplayName("Type of Duty")]
        [UIHint("DropDownList")]
        ...
        {
            configuration.CreateMap<Person, BattalionProfileViewModel>()
                ...
                .ForMember(m => m.StationName, opt => opt.MapFrom(u => u.Station.Name))
                .ForMember(m => m.JobTypeValue,
                    opt => opt.MapFrom(u => ServiceUtil.FatchLookupValue(AppConstant.LookupType.Job_Type, u.JobTypeKey)));
